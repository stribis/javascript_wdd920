...
var zahl1 = parseInt(prompt('Enter first number'))  // 2
var operator = prompt('Enter operator (+,-,/,*)') // +
var zahl2 = parseInt(prompt('Enter second number')) // 2 

if ( isNaN(zahl1) || isNaN(zahl2)){
  alert('Make sure your use numbers')
} else if( operator === "+") {
  // Add
  alert(zahl1 + zahl2)
} else if ( operator === "-"){
  ...
  alert('Incorrect Operator, refresh and try again')
}
