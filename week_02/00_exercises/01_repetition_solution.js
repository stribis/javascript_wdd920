...
/* 4. Fix this console log so that it correctly concatenates your string - Use existing variables */


console.log('My name is ' + name + ' , I am ' + age + ' years old and love ' + hobby + '!');
